<# Bir alt satirdaki kodu tek basina calistirin !!! #>
...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\baris\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma1.ps1'
...
$action = New-ScheduledTaskAction -Execute 'Powershell.exe'  -Argument 'C:\Users\baris\Desktop\Scripts-IsletimSistemleriFinalOdevi\algoritma2.ps1'
